        ...
        <div class="bg-white shadow-lg rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div class="p-8">
                ...
                <div class="flex items-center gap-4 mb-8 pb-6 border-b border-gray-100">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-gray-800">Ubah Tahun Ajaran</h3>
                        <p class="text-xs text-gray-400 mt-0.5">Silakan perbarui detail data tahun ajaran sekolah.</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('admin.manage.tahun-ajarans.update', $tahunAjaran->id) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="tahun_ajaran" id="tahun_ajaran" value="{{ old('tahun_ajaran', $tahunAjaran->tahun_ajaran) }}" required autofocus
                    ...
                    <div>
                        ...
                        <select name="is_active" id="is_active" required
                            ...
                            <option value="1" {{ old('is_active', $tahunAjaran->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Aktif</option>
                            <option value="0" {{ old('is_active', $tahunAjaran->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                        </select>
