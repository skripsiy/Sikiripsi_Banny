<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto font-sans">
        ...
        <!-- Filter Panel -->
        <form method="GET" action="{{ route('guru.absensi.show', $classroom->id) }}" class="bg-white rounded-2xl border border-gray-100 p-5 mb-6 shadow-sm">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <label for="mata_pelajaran_id" class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Mata Pelajaran Anda</label>
                    <select name="mata_pelajaran_id" id="mata_pelajaran_id" onchange="this.form.submit()"
                            class="w-full px-4 py-2.5 bg-gray-50 border border-gray-150 rounded-xl text-xs text-gray-700 font-semibold focus:outline-none focus:bg-white focus:border-[#0c2b4d] focus:ring-1 focus:ring-[#0c2b4d] transition-all cursor-pointer">
                        <option value="">Semua Mata Pelajaran Anda (Gabungan)</option>
