<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto font-sans">
        <div class="mb-6">
            <h3 class="text-base font-bold text-gray-800">Pilih Kelas untuk Melihat Absensi</h3>
            <p class="text-xs text-gray-400 mt-1">Daftar kelas aktif beserta total siswa terdaftar. Klik tombol Lihat Absensi untuk melihat rekapitulasi kehadiran.</p>
        </div>
                ...
                <div class="overflow-x-auto">
                                ...
                                @foreach ($classrooms as $cls)
                                    <tr class="hover:bg-gray-50/50 transition-all duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 font-medium">
                                            {{ $cls->jurusan->nama_jurusan ?? '-' }} ({{ $cls->jurusan->kode_jurusan ?? '-' }})
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium">
                                            <a href="{{ route('admin.manage.absensi.show', $cls->id) }}" 
                    ...
                    @else
                        ...
                        <div class="flex flex-col items-center justify-center py-12 text-center">
                            ...
                            <p class="text-sm text-gray-400 max-w-sm">Data kelas belum tersedia atau belum di-aktifkan.</p>
                        </div>
                    @endif
                </div>
            </div>
