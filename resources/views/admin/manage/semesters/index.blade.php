                                    ...
                                    <tr class="hover:bg-gray-50/50 transition-all duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium">
                                            <div class="flex items-center justify-center gap-3">
                                                ...
                                                <form action="{{ route('admin.manage.semesters.destroy', $ta->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus tahun ajaran ini?');" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
