                    ...
                    @if ($semesters->isNotEmpty())
                        <table class="min-w-full divide-y divide-gray-100">
                            <thead class="bg-gray-50/75">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Tahun Akademik</th>
                                    <th class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Semester</th>
                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                @foreach ($semesters as $ta)
                                    <tr class="hover:bg-gray-50/50 transition-all duration-150"
                                        ...
                                        <td class="px-6 py-2.5 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $ta->tahunAkademik->tahun_ajaran ?? '-' }}</td>
                                        <td class="px-6 py-2.5 whitespace-nowrap text-sm text-gray-500 capitalize">{{ $ta->semester }}</td>
                                        <td class="px-6 py-2.5 whitespace-nowrap text-sm text-gray-500">{{ $ta->start_date ? $ta->start_date->format('d M Y') : '-' }}</td>
                                        <td class="px-6 py-2.5 whitespace-nowrap text-sm text-gray-500">{{ $ta->end_date ? $ta->end_date->format('d M Y') : '-' }}</td>
