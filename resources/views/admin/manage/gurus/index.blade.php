<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto font-sans">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
            <h3 class="text-base font-semibold text-gray-700">Daftar Akun Guru</h3>
            
            <div class="flex flex-wrap items-center gap-3">
                <!-- Import Form -->
                <form action="{{ route('admin.manage.gurus.import') }}" method="POST" enctype="multipart/form-data" class="flex items-center gap-2 bg-white px-4 py-1.5 border border-gray-200 rounded-lg shadow-sm">
                    @csrf
                ...
                <!-- Add Button -->
                <a href="{{ route('admin.manage.gurus.create') }}" 
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">NUPTK</th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Spesialisasi Mata Pelajaran</th>
                                <th class="px-6 py-4 text-center text-xs font-semibold text-gray-500 uppercase tracking-wider w-36">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-100">
                            @forelse ($gurus as $userObj)
                                <tr class="hover:bg-gray-50/50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-center font-medium">
                                        <div class="flex items-center justify-center gap-3">
                                            <a href="{{ route('admin.manage.gurus.edit', $userObj->id) }}" class="text-blue-600 hover:text-blue-900 transition-colors font-semibold">Edit</a>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-8 text-center text-sm text-gray-400">Tidak ada data guru.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
