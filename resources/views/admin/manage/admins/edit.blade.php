<div class="flex items-center gap-4 mb-6 pb-4 border-b border-gray-100">
    ...
    <div>
        <h3 class="text-lg font-bold text-gray-800">Edit Akun Admin</h3>
        <p class="text-xs text-gray-400 mt-0.5">Silakan perbarui detail data administrator.</p>
    </div>
</div>
...
<form method="POST" :action="editUrl" class="space-y-4">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="fullname" id="edit_fullname" x-model="editData.fullname" required maxlength="50"
        ...
        <div>
            ...
            <input type="text" name="username" id="edit_username" x-model="editData.username" required maxlength="25"
                   class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#0c2b4d] focus:ring-1 focus:ring-[#0c2b4d] text-sm text-gray-800 transition-all shadow-sm">
            @if(old('_method') === 'PUT')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            ...
            <input type="email" name="email" id="edit_email" x-model="editData.email" required maxlength="100"
                   class="w-full px-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-[#0c2b4d] focus:ring-1 focus:ring-[#0c2b4d] text-sm text-gray-800 transition-all shadow-sm">
            @if(old('_method') === 'PUT')
        ...
        <div>
            ...
            <input type="text" name="nip" id="edit_nip" x-model="editData.nip" required maxlength="18"
