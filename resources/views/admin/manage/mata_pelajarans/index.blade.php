<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto font-sans" x-data="{
        ...
        createKodePelajaran: '{{ old('kode_pelajaran') ?? '' }}',
        editData: {
            id: '{{ old('id') ?? '' }}',
        ...
        editUrl: '{{ old('id') ? route('admin.manage.mata_pelajarans.update', old('id')) : '' }}',
        generateRandomCode() {
        ...
        <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6">
            ...
            <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                <!-- Import Form -->
                <form action="{{ route('admin.manage.mata_pelajarans.import') }}" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 bg-white p-3 sm:px-4 sm:py-2 border border-gray-100 rounded-xl shadow-sm w-full sm:w-auto">
                    @csrf
                ...
                <!-- Download Template -->
                <a href="{{ route('admin.manage.mata_pelajarans.template') }}" 
