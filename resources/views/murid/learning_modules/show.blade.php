<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto font-sans">
            ...
            <div>
                ...
                <div class="mt-4 flex items-center gap-2">
                    <span class="text-xs bg-white/10 px-3 py-1.5 rounded-lg text-blue-100 flex items-center gap-1.5 select-none">
                        ...
                        <span>Pengajar: <strong class="text-white">{{ $learningModule->guru->user->name ?? 'Guru Pengampu' }}</strong></span>
                    </span>
                </div>
            </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
            ...
            <!-- Materi Card -->
            <a href="{{ route('murid.learning-modules.materis.index', $learningModule->id) }}"
            ...
            <!-- Tugas Card -->
            <a href="{{ route('murid.learning-modules.tugas.index', $learningModule->id) }}"
            ...
            <!-- Ujian Card -->
            <a href="{{ route('murid.learning-modules.ujians.index', $learningModule->id) }}"
