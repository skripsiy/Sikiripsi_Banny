                            ...
                            <tbody class="bg-white divide-y divide-gray-100">
                                @foreach ($admins as $userObj)
                                    <tr class="hover:bg-gray-50/50 transition-all duration-150"
                                        x-show="searchQuery === '' || 
                                                 {{ json_encode(strtolower($userObj->admin->fullname ?? $userObj->name)) }}.includes(searchQuery.toLowerCase()) || 
                                                 ...
                                                 {{ json_encode(strtolower($userObj->admin->nip ?? '')) }}.includes(searchQuery.toLowerCase())">
