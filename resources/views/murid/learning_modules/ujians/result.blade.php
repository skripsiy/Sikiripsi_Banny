    ...
    <div class="max-w-7xl mx-auto font-sans px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-3xl border border-gray-150 p-6 md:p-8 shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-6 relative overflow-hidden">
            ...
            <div class="space-y-3 text-left z-10">
                ...
                <div>
                    <h2 class="text-lg font-extrabold text-gray-800">Hasil Ujian - {{ $ujian->title }}</h2>
                    <p class="text-xs text-gray-400 mt-1">Ujian Anda telah selesai dikerjakan dan dikirimkan.</p>
                </div>
